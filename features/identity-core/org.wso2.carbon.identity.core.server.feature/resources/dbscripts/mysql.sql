...
CREATE TABLE IF NOT EXISTS IDN_AUTH_USER (
            ...
            PRIMARY KEY (USER_ID),
            CONSTRAINT USER_STORE_CONSTRAINT UNIQUE (USER_NAME, TENANT_ID, DOMAIN_NAME, IDP_ID))DEFAULT CHARACTER SET latin1;
...
CREATE TABLE IF NOT EXISTS SP_TEMPLATE (
  ...
  CONTENT BLOB DEFAULT NULL,
  PRIMARY KEY (ID),
  CONSTRAINT SP_TEMPLATE_CONSTRAINT UNIQUE (TENANT_ID, NAME))DEFAULT CHARACTER SET latin1 ;
...
CREATE TABLE IF NOT EXISTS IDN_AUTH_WAIT_STATUS (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT IDN_AUTH_WAIT_STATUS_KEY UNIQUE (LONG_WAIT_KEY))DEFAULT CHARACTER SET latin1 ;
...
CREATE TABLE IF NOT EXISTS IDN_DUMMY_TABLE (
    ID INTEGER NOT NULL AUTO_INCREMENT,
    NAME VARCHAR(255) NOT NULL,
    DESCRIPTION VARCHAR(1023) NULL,
    PRIMARY KEY (ID),
